package org.pizza.pay.util.sign;


import cn.hutool.core.util.StrUtil;
import org.apache.http.message.BasicNameValuePair;
import org.pizza.pay.bean.SignType;
...
public enum SignUtils implements SignType {
    ...
    MD5 {
        ...
        public String createSign(String content, String key, String characterEncoding) {
            ...
            return org.pizza.pay.util.sign.encrypt.MD5.sign(content, key, characterEncoding);
        }
        ...
        public boolean verify(String text, String sign, String key, String characterEncoding) {
            return org.pizza.pay.util.sign.encrypt.MD5.verify(text, sign, key, characterEncoding);
        }
    }, HMACSHA256 {
        @Override
    ...
    RSA {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return org.pizza.pay.util.sign.encrypt.RSA.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return org.pizza.pay.util.sign.encrypt.RSA.verify(text, sign, publicKey, characterEncoding);
        }
    },
    ...
    RSA2 {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return org.pizza.pay.util.sign.encrypt.RSA2.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return org.pizza.pay.util.sign.encrypt.RSA2.verify(text, sign, publicKey, characterEncoding);
        }
    },
    SHA1 {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return org.pizza.pay.util.sign.encrypt.SHA1.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return org.pizza.pay.util.sign.encrypt.SHA1.verify(text, sign, publicKey, characterEncoding);
        }
    },
    SHA256 {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return org.pizza.pay.util.sign.encrypt.SHA256.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return org.pizza.pay.util.sign.encrypt.SHA256.verify(text, sign, publicKey, characterEncoding);
        }
    },
    SM3 {
        @Override
    ...
    private static String sortMapParameterText(Map<String, Object> parameters, String separator, boolean ignoreNullValue, String... ignoreKey) {
        ...
        for (String k : keys) {
            ...
            if (StrUtil.isBlank(valueStr) || (null != ignoreKey && Arrays.binarySearch(ignoreKey, k) >= 0)) {
                continue;
            }
